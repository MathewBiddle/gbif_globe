...
geojson_string <- geojsonsf::sf_geojson(grid_dec[c("es","geometry")])

write(x=geojson_string, file="es50_2000_2001_res3.geojson")
```
...
for (dec in decs){
  ...
  fname <- sprintf("data/%s_%s_%s_res%s.geojson",column,dec_beg,dec_end,res)
